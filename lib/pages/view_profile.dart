            ...
            body: FutureBuilder<QuerySnapshot<Object?>?>(
                ...
                builder: (BuildContext context,
                  ...
                  if (snapshot.hasError) {
                    ...
                    final employment =
                        snapshot.data!.docs.first.get('employment');
                    final url = snapshot.data!.docs.first.get('image');
                    final state = snapshot.data!.docs.first.get('state');
                    final has_place = snapshot.data!.docs.first.get('has_place')
                        ? "yes"
                        : "no";
                    final alcohol =
                        snapshot.data!.docs.first.get('alcohol') ? "yes" : "no";
                    final smoking =
                        snapshot.data!.docs.first.get('smoking') ? "yes" : "no";
                    final diet = snapshot.data!.docs.first.get('diet');
                    final introvert = snapshot.data!.docs.first.get('introvert')
                        ? "introvert"
                        : "exptrovert";
                    final hasPet = snapshot.data!.docs.first.get('introvert')
                        ? "yes"
                        : "no";
